# Escritorio Digital – Guia de widgets

Escritorio Digital é um quadro de trabalho com “janelas” pensado para a sala de aula. Pode abrir os widgets necessários, movê‑los, redimensioná‑los e combiná‑los para criar a sua “mesa de trabalho” para uma atividade.
...
### Organização e sala de aula

- **Lista de tarefas**: lista de tarefas/lembretes. Útil para a agenda do dia, passos de uma prática, rubrica rápida ou “plano da sessão”.
...
- **Dado**: lançamentos rápidos para azar, gamificação ou seleção aleatória.
- **Roleta aleatória**: sorteia turnos, equipas, perguntas, alunos ou desafios.
...
- **Jogo do galo**: jogo rápido para revisão, perguntas‑respostas, motivação ou “duelos” de conceitos.
